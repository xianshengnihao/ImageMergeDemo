...
public class YmlUtils {
    ...
    private static String bootstrap_file = "classpath:bootstrap.yml";
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        Map<String, String> ymlByFileName = getYmlByFileName(bootstrap_file,"server.port","spring.application.name");
